...
void cleancachegit()
{
	...
	DeleteUrlCacheEntry("https://raw.githubusercontent.com/djdjz7/AAS/Switcher/AAS.exe");
	DeleteUrlCacheEntry("https://raw.githubusercontent.com/djdjz7/AAS/Switcher/av.sver");
	DeleteUrlCacheEntry("https://raw.githubusercontent.com/djdjz7/AAS/Switcher/cfa.conform");
	DeleteUrlCacheEntry("https://raw.githubusercontent.com/djdjz7/AAS/Switcher/xyl.exe");
	DeleteUrlCacheEntry("https://raw.githubusercontent.com/djdjz7/AAS/Switcher/xv.sver");
	DeleteUrlCacheEntry("https://raw.githubusercontent.com/djdjz7/AAS/Switcher/cfx.conform");
	DeleteUrlCacheEntry("https://raw.githubusercontent.com/djdjz7/AAS/Switcher/Setup.exe");
	DeleteUrlCacheEntry("https://raw.githubusercontent.com/djdjz7/AAS/Switcher/cfs.conform");
	DeleteUrlCacheEntry("https://raw.githubusercontent.com/djdjz7/AAS/Switcher/addon.exe");
	DeleteUrlCacheEntry("https://raw.githubusercontent.com/djdjz7/AAS/Switcher/cfado.conform");
}
void downloadgitaas()
{
	int retry = 1, fail = 0;
	while (retry <= 3)
	{
		...
		URLDownloadToFile(NULL, TEXT("https://raw.githubusercontent.com/djdjz7/AAS/Switcher/AAS.exe"), TEXT(".\\Resources\\AAS.exe"), 0, NULL);
		URLDownloadToFile(NULL, TEXT("https://raw.githubusercontent.com/djdjz7/AAS/Switcher/av.sver"), TEXT(".\\Resources\\av.sver"), 0, NULL);
		URLDownloadToFile(NULL, TEXT("https://raw.githubusercontent.com/djdjz7/AAS/Switcher/cfa.conform"), TEXT(".\\Resources\\cfa.conform"), 0, NULL);
...
void downloadgitxyl()
{
	...
	while (retry <= 3)
	{
		...
		URLDownloadToFile(NULL, TEXT("https://raw.githubusercontent.com/djdjz7/AAS/Switcher/xyl.exe"), TEXT(".\\Resources\\xyl.exe"), 0, NULL);
		URLDownloadToFile(NULL, TEXT("https://raw.githubusercontent.com/djdjz7/AAS/Switcher/xv.sver"), TEXT(".\\Resources\\xv.sver"), 0, NULL);
		URLDownloadToFile(NULL, TEXT("https://raw.githubusercontent.com/djdjz7/AAS/Switcher/cfx.conform"), TEXT(".\\Resources\\cfx.conform"), 0, NULL);
...
void downloadgitsetup()
{
	...
	while (retry <= 3)
	{
		...
		URLDownloadToFile(NULL, TEXT("https://raw.githubusercontent.com/djdjz7/AAS/Switcher/Setup.exe"), TEXT(".\\Resources\\Setup.exe"), 0, NULL);
		URLDownloadToFile(NULL, TEXT("https://raw.githubusercontent.com/djdjz7/AAS/Switcher/cfs.conform"), TEXT(".\\Resources\\cfs.conform"), 0, NULL);
...
void downloadgitaddon()
{
	...
	while (retry <= 3)
	{
		...
		URLDownloadToFile(NULL, TEXT("https://raw.githubusercontent.com/djdjz7/AAS/Switcher/addon.exe"), TEXT(".\\Resources\\addon.exe"), 0, NULL);
		URLDownloadToFile(NULL, TEXT("https://raw.githubusercontent.com/djdjz7/AAS/Switcher/cfado.conform"), TEXT(".\\Resources\\cfado.conform"), 0, NULL);
...
start:	op=_getch()-48;
	...
	if (op == 1) {
		...
		URLDownloadToFile(NULL, TEXT("https://raw.githubusercontent.com/djdjz7/AAS/Switcher/upver.sver"), TEXT(".\\Resources\\upver.sver"), 0, NULL);
		if ((_access(".\\Resources\\upver.sver", 0)) == -1)
		{
			if (lcid == 2052)
				cout << "检查更新失败" << endl;
		...
		in.close();
		system("CLS");
		int currentxvlen = CurrentXYLVersion.length();
		int newxvlen = NewXYLVersion.length();
		int currentavlen = CurrentAASVersion.length();
		int newavlen = NewAASVersion.length();
		for (int i = 0; i <= 4; i ++)
		{
		...
		if (currentavlen < newavlen && CurrentAASVersion[0] <= NewAASVersion[0])
			na = 1;
		if (currentxvlen < newxvlen && CurrentXYLVersion[0] <= NewXYLVersion[0])
			nx = 1;
		if (adon > ado) nado = 1;
		if (adon < ado) nado = -1;
